...
void gnuplot_plot_once (char *style, char *label_x, char *label_y, double *x, double *y, int n, char *title) {
  ...
  gnuplot_setstyle(handle, (char*) ((style == NULL) ? "lines" : style));
  gnuplot_set_axislabel(handle, "x", (char*) ((label_x == NULL) ? "X" : label_x));
  gnuplot_set_axislabel(handle, "y", (char*) ((label_y == NULL) ? "Y" : label_y));
